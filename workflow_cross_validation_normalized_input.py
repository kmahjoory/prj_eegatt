...
from eegatt_tools.models import CnnCos1layer, weight_init
...
class EEGDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        eeg0 = torch.from_numpy(sig)
        eeg = (eeg0 - eeg0.mean(axis=1, keepdim=True)) / eeg0.std(axis=1, keepdim=True)
...
########################################################################################################################
lr_searchspace = [1e-3, 4*1e-3, 7*1e-3, 1e-2]
