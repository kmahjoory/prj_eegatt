...
def load_prepare_data_5sec(indx_subj, indx_test_seg=5, indx_subgroup='*'):
    ...
    r_fpath = set(glob.glob(f'{data_path}{data_dir}r/s_{indx_subj}_{indx_subgroup}.npy'))
    r_fpath_test = set(glob.glob(f'{data_path}{data_dir}r/s_{indx_subj}_*seg_{indx_test_seg}{indx_subgroup}.npy'))
    r_fpath_rm = set.union(set(glob.glob(f'{data_path}{data_dir}r/s_{indx_subj}_*seg_{indx_test_seg-1}{indx_subgroup}.npy')), set(glob.glob(f'{data_path}{data_dir}r/s_{indx_subj}_*seg_{indx_test_seg+1}{indx_subgroup}.npy')))
